...
public class CollectionManager {
    ...
    public CollectionManager(DumpManager dumpManager, Console console) throws JAXBException {
    ...
    public void saveCollection(String filename, Console console) throws JAXBException {
        try {
